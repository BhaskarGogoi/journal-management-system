                    ...
                    <div class="card shadow" style="margin:auto; width: 100%;">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id='title' onkeyup="validateInput()" class="form-control" required>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" id='author' class="form-control" onkeyup="validateInput()">
                            </div>
                            <div class="form-group">
                                <label>Select Journal</label>
                                <select id='journal_id' class="form-control" required>
                                    <?php
